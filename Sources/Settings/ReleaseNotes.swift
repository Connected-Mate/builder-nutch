...
enum ReleaseNotes {
    static let all: [ReleaseNote] = [
        ...
        ReleaseNote(version: "0.22.1", headline: "Choose an account. Know its limits.", changes: [
            ...
            .init(title: "Keep a working login", detail: "A failed usage check or an exhausted shared allowance no longer lets a manual switch replace the current login.")
        ]),
        ...
        ReleaseNote(version: "0.18.0", headline: "Your day, ready to share.", changes: [
            .init(title: "Sharing in focus", detail: "A visible preview opens your image above the app, with a blurred background. Choose a period or project, then copy or save."),
            .init(title: "A daily invitation", detail: "At 17:30, a notification opens your card for today. Turn it off anytime in Settings.")
        ]),
        ReleaseNote(version: "0.17.0", headline: "Your AI, your activity.", changes: [
            .init(title: "A podium for your day", detail: "Your most-used AI sets the color of your share card. Export your day, week or month, for all activity or one project.")
        ]),
        ReleaseNote(version: "0.16.2", headline: "A cooler light.", changes: [
            .init(title: "White gradients", detail: "White light replaces the warm yellow tones in the sharing background and day card.")
        ]),
        ...
        ReleaseNote(version: "0.15.0", headline: "A clearer view of your activity.", changes: [
            .init(title: "A more refined usage view", detail: "A compact daily chart, clearer token figures and smooth transitions make your saved activity easier to explore."),
            .init(title: "Explore each day", detail: "Select a day to see its recorded tokens. Keyboard navigation and reduced motion are supported.")
        ]),
        ReleaseNote(version: "0.14.0", headline: "Your history, one milestone at a time.", changes: [
            .init(title: "Stamps for your saved tokens", detail: "Reach eight levels from 100,000 to one trillion recorded tokens. Your progress follows saved history, independently of the selected period."),
            .init(title: "More complete token readings", detail: "Archived Codex sessions are included. Large transcript reads and cumulative counter changes are handled more accurately.")
        ]),
