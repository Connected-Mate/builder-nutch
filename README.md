...
- Account rings show the most restrictive **shared** allowance, consistently in the notch and account list. Model-specific allowances are shown separately: Fable reaching its weekly limit does not turn a 55%-used shared allowance into 100%. A missing shared reading stays unknown.
